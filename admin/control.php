    ...
    class control extends model //s2
    {
        function __construct(){
            ...
            if(isset($_REQUEST['status_emp_id']))
            {
                ...
                $emp_status=$res_fetch->emp_status;
                if($emp_status=="block")
                {
                    $data=array("emp_status"=>"Unblock");
            ...
            case '/manage_area':
            $area_arr=$this->select_join3('area_master','city_master','area_master.city_id=city_master.city_id','state_master','area_master.st_id=state_master.st_id');
            ...
            $bc_arr=$this->select('booking_master');
